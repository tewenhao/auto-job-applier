...
_SYSTEM = (
    ...
    "- 3-4 experiences, 2-3 dense bullets each (2 is the norm; a 3rd only for a "
    "standout role). A short but prestigious role or selective programme (e.g. an "
    "insight programme / spring week) is worth its own SHORT 1-bullet experience "
    "entry — surface it here rather than burying it in the skills lines.\n"
